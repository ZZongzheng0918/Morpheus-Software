...
def main():
    parser = argparse.ArgumentParser(description='Morpheus: A Neural-driven Animatronic Face with Hybrid Actuation and Diverse Emotion Control')
    ...
    parser.add_argument("--feature_dim", type=int, default=832, help='64 for vocaset; 128 for BIWI')
    parser.add_argument("--period", type=int, default=30, help='period in PPE - 30 for vocaset; 25 for BIWI')
    parser.add_argument("--model_path", type=str, default="./pretrain_model/model.pth",
    ...
    parser.add_argument("--emo_guide", type=bool, default=True, help='emotion guided')
